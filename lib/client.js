...
IMAPClient.prototype.getNewMail = function(lastUID,callback){
    ...
    if(lastUID===0){
        ...
        this._send("UID FETCH "+(lastUID+1)+":* (UID FLAGS ENVELOPE BODY[HEADER.FIELDS (REFERENCES THREAD-INDEX)]" +(this._capabilities.indexOf("X-GM-EXT-1")>=0?" X-GM-LABELS X-GM-THRID":"")+ ")", (function(status){
            this._collectMailList = false;
            if(typeof callback != "function"){
                return;
            }
